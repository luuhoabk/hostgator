...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2015 at 08:38 AM
...
--
-- Database: `db_hostgator`
--

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_assets`
--

CREATE TABLE IF NOT EXISTS `t1opn_assets` (
...
--
-- Dumping data for table `t1opn_assets`
--

INSERT INTO `t1opn_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(39, 18, 42, 43, 2, 'com_modules.module.1', 'Main Menu', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}'),
...
(54, 27, 19, 20, 3, 'com_content.article.1', 'test template', '{"core.delete":{"6":1},"core.edit":{"6":1,"4":1},"core.edit.state":{"6":1,"5":1}}');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_associations`
--

CREATE TABLE IF NOT EXISTS `t1opn_associations` (
...
--
-- Table structure for table `t1opn_banners`
--

CREATE TABLE IF NOT EXISTS `t1opn_banners` (
`id` int(11) NOT NULL,
...
--
-- Table structure for table `t1opn_banner_clients`
--

CREATE TABLE IF NOT EXISTS `t1opn_banner_clients` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Table structure for table `t1opn_banner_tracks`
--

CREATE TABLE IF NOT EXISTS `t1opn_banner_tracks` (
...
--
-- Table structure for table `t1opn_categories`
--

CREATE TABLE IF NOT EXISTS `t1opn_categories` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `t1opn_categories`
--

INSERT INTO `t1opn_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
...
--
-- Table structure for table `t1opn_contact_details`
--

CREATE TABLE IF NOT EXISTS `t1opn_contact_details` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
  `alias` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Table structure for table `t1opn_content`
--

CREATE TABLE IF NOT EXISTS `t1opn_content` (
...
--
-- Dumping data for table `t1opn_content`
--

INSERT INTO `t1opn_content` (`id`, `asset_id`, `title`, `alias`, `introtext`, `fulltext`, `state`, `catid`, `created`, `created_by`, `created_by_alias`, `modified`, `modified_by`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `images`, `urls`, `attribs`, `version`, `ordering`, `metakey`, `metadesc`, `access`, `hits`, `metadata`, `featured`, `language`, `xreference`) VALUES
(1, 54, 'test template', 'test-template', '<p>Hostgator coupons</p>', '', 1, 2, '2015-02-08 20:46:04', 990, '', '0000-00-00 00:00:00', 0, 0, '0000-00-00 00:00:00', '2015-02-08 20:46:04', '0000-00-00 00:00:00', '{"image_intro":"","float_intro":"","image_intro_alt":"","image_intro_caption":"","image_fulltext":"","float_fulltext":"","image_fulltext_alt":"","image_fulltext_caption":""}', '{"urla":false,"urlatext":"","targeta":"","urlb":false,"urlbtext":"","targetb":"","urlc":false,"urlctext":"","targetc":""}', '{"show_title":"","link_titles":"","show_tags":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_vote":"","show_hits":"","show_noauth":"","urls_position":"","alternative_readmore":"","article_layout":"","show_publishing_options":"","show_article_options":"","show_urls_images_backend":"","show_urls_images_frontend":""}', 1, 0, '', '', 1, 297, '{"robots":"","author":"","rights":"","xreference":""}', 0, '*', '');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_contentitem_tag_map`
--

CREATE TABLE IF NOT EXISTS `t1opn_contentitem_tag_map` (
...
--
-- Table structure for table `t1opn_content_frontpage`
--

CREATE TABLE IF NOT EXISTS `t1opn_content_frontpage` (
...
--
-- Table structure for table `t1opn_content_rating`
--

CREATE TABLE IF NOT EXISTS `t1opn_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Table structure for table `t1opn_content_types`
--

CREATE TABLE IF NOT EXISTS `t1opn_content_types` (
...
--
-- Dumping data for table `t1opn_content_types`
--

INSERT INTO `t1opn_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Table structure for table `t1opn_core_log_searches`
--

CREATE TABLE IF NOT EXISTS `t1opn_core_log_searches` (
...
--
-- Table structure for table `t1opn_extensions`
--

CREATE TABLE IF NOT EXISTS `t1opn_extensions` (
...
--
-- Dumping data for table `t1opn_extensions`
--

INSERT INTO `t1opn_extensions` (`extension_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"81d1abf1089fefd9dee25271d3344485"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(10000, 'hostgator', 'template', 'hostgator', '', 0, 1, 1, 0, '{"name":"hostgator","type":"template","creationDate":"4\\/30\\/2012","author":"luhoabk","copyright":"Copyright (C) 2015 Open Source Matters, Inc. All rights reserved.","authorEmail":"luuhoabk.developer@gmail.com","authorUrl":"","version":"1.0","description":"TPL_HOSTGATOR_XML_DESCRIPTION","group":""}', '{"templateColor":"#08C","templateBackgroundColor":"#F4F6F7","logoFile":"","sitetitle":"","sitedescription":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}', '', '', 0, '0000-00-00 00:00:00', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_finder_filters`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_filters` (
...
--
-- Table structure for table `t1opn_finder_links`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links` (
...
--
-- Table structure for table `t1opn_finder_links_terms0`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms0` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_finder_links_terms1`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms1` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms2`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms2` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms3`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms3` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms4`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms4` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms5`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms5` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms6`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms6` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms7`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms7` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms8`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms8` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_terms9`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_terms9` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termsa`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termsa` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termsb`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termsb` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termsc`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termsc` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termsd`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termsd` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termse`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termse` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_links_termsf`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_links_termsf` (
  `link_id` int(10) unsigned NOT NULL,
  `term_id` int(10) unsigned NOT NULL,
  `weight` float unsigned NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Table structure for table `t1opn_finder_taxonomy`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_taxonomy` (
`id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Dumping data for table `t1opn_finder_taxonomy`
--

INSERT INTO `t1opn_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_finder_taxonomy_map`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_taxonomy_map` (
  `link_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_finder_terms`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_terms` (
`term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_finder_terms_common`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `t1opn_finder_terms_common`
--

INSERT INTO `t1opn_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Table structure for table `t1opn_finder_tokens`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `phrase` tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `t1opn_finder_tokens_aggregate`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_tokens_aggregate` (
  `term_id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_finder_types`
--

CREATE TABLE IF NOT EXISTS `t1opn_finder_types` (
`id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_languages`
--

CREATE TABLE IF NOT EXISTS `t1opn_languages` (
...
--
-- Dumping data for table `t1opn_languages`
--

INSERT INTO `t1opn_languages` (`lang_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_menu`
--

CREATE TABLE IF NOT EXISTS `t1opn_menu` (
`id` int(11) NOT NULL,
...
--
-- Dumping data for table `t1opn_menu`
--

INSERT INTO `t1opn_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
(102, 'mainmenu', 'Menu 1', 'menu-1', '', 'menu-1', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 49, 50, 0, '*', 0),
(103, 'mainmenu', 'Menu 2', 'menu-2', '', 'menu-2', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 51, 52, 0, '*', 0),
(104, 'mainmenu', 'Menu 3', 'menu-3', '', 'menu-3', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 53, 54, 0, '*', 0),
(105, 'mainmenu', 'Menu 4', 'menu-4', '', 'menu-4', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 55, 56, 0, '*', 0),
(106, 'mainmenu', 'Menu 5', 'menu-5', '', 'menu-5', 'index.php?option=com_content&view=article&id=1', 'component', 1, 1, 1, 22, 0, '0000-00-00 00:00:00', 0, 1, '', 0, '{"show_title":"","link_titles":"","show_intro":"","info_block_position":"","show_category":"","link_category":"","show_parent_category":"","link_parent_category":"","show_author":"","link_author":"","show_create_date":"","show_modify_date":"","show_publish_date":"","show_item_navigation":"","show_vote":"","show_icons":"","show_print_icon":"","show_email_icon":"","show_hits":"","show_tags":"","show_noauth":"","urls_position":"","menu-anchor_title":"","menu-anchor_css":"","menu_image":"","menu_text":1,"page_title":"","show_page_heading":0,"page_heading":"","pageclass_sfx":"","menu-meta_description":"","menu-meta_keywords":"","robots":"","secure":0}', 57, 58, 0, '*', 0);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_menu_types`
--

CREATE TABLE IF NOT EXISTS `t1opn_menu_types` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `t1opn_menu_types`
--

INSERT INTO `t1opn_menu_types` (`id`, `menutype`, `title`, `description`) VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_messages`
--

CREATE TABLE IF NOT EXISTS `t1opn_messages` (
...
--
-- Table structure for table `t1opn_messages_cfg`
--

CREATE TABLE IF NOT EXISTS `t1opn_messages_cfg` (
...
--
-- Table structure for table `t1opn_modules`
--

CREATE TABLE IF NOT EXISTS `t1opn_modules` (
`id` int(11) NOT NULL,
  `asset_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Dumping data for table `t1opn_modules`
--

INSERT INTO `t1opn_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
(1, 39, 'Main Menu', '', '', 1, 'position-1', 990, '2015-02-08 20:55:37', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 'mod_menu', 1, 1, '{"menutype":"mainmenu","base":"","startLevel":"1","endLevel":"0","showAllChildren":"0","tag_id":"","class_sfx":" nav-pills","window_open":"","layout":"_:default","moduleclass_sfx":"_menu","cache":"1","cache_time":"900","cachemode":"itemid","module_tag":"div","bootstrap_size":"0","header_tag":"h3","header_class":"","style":"0"}', 0, '*'),
...
--
-- Table structure for table `t1opn_modules_menu`
--

CREATE TABLE IF NOT EXISTS `t1opn_modules_menu` (
  `moduleid` int(11) NOT NULL DEFAULT '0',
  `menuid` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `t1opn_modules_menu`
--

INSERT INTO `t1opn_modules_menu` (`moduleid`, `menuid`) VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Table structure for table `t1opn_newsfeeds`
--

CREATE TABLE IF NOT EXISTS `t1opn_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
`id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_overrider`
--

CREATE TABLE IF NOT EXISTS `t1opn_overrider` (
...
--
-- Table structure for table `t1opn_postinstall_messages`
--

CREATE TABLE IF NOT EXISTS `t1opn_postinstall_messages` (
...
--
-- Dumping data for table `t1opn_postinstall_messages`
--

INSERT INTO `t1opn_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Table structure for table `t1opn_redirect_links`
--

CREATE TABLE IF NOT EXISTS `t1opn_redirect_links` (
`id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_schemas`
--

CREATE TABLE IF NOT EXISTS `t1opn_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `t1opn_schemas`
--

INSERT INTO `t1opn_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.3.6-2014-09-30');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_session`
--

CREATE TABLE IF NOT EXISTS `t1opn_session` (
...
--
-- Dumping data for table `t1opn_session`
--

INSERT INTO `t1opn_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('ba2d8icmecgo6llqtbus5njca4', 0, 1, '1423467391', '__default|a:8:{s:15:"session.counter";i:132;s:19:"session.timer.start";i:1423462145;s:18:"session.timer.last";i:1423467390;s:17:"session.timer.now";i:1423467390;s:22:"session.client.browser";s:109:"Mozilla/5.0 (Windows NT 6.3; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36";s:8:"registry";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":25:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:12:"requireReset";N;s:10:"\\0\\0\\0_params";O:24:"Joomla\\Registry\\Registry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:16:"com_mailto.links";a:1:{s:40:"b2ac7ccbdb4ca67280eba8bf2978812c5ab5fb1e";O:8:"stdClass":2:{s:4:"link";s:27:"http://hostgator.net/menu-1";s:6:"expiry";i:1423467390;}}}', 0, '');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_tags`
--

CREATE TABLE IF NOT EXISTS `t1opn_tags` (
`id` int(10) unsigned NOT NULL,
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Dumping data for table `t1opn_tags`
--

INSERT INTO `t1opn_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_template_styles`
--

CREATE TABLE IF NOT EXISTS `t1opn_template_styles` (
`id` int(10) unsigned NOT NULL,
...
--
-- Dumping data for table `t1opn_template_styles`
--

INSERT INTO `t1opn_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
(4, 'beez3', 0, '0', 'Beez3 - Default', '{"wrapperSmall":"53","wrapperLarge":"72","logo":"images\\/joomla_black.gif","sitetitle":"Joomla!","sitedescription":"Open Source Content Management","navposition":"left","templatecolor":"personal","html5":"0"}'),
(5, 'hathor', 1, '0', 'Hathor - Default', '{"showSiteName":"0","colourChoice":"","boldText":"0"}'),
(7, 'protostar', 0, '0', 'protostar - Default', '{"templateColor":"","logoFile":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}'),
(8, 'isis', 1, '1', 'isis - Default', '{"templateColor":"","logoFile":""}'),
(9, 'hostgator', 0, '1', 'hostgator - Default', '{"templateColor":"#08C","templateBackgroundColor":"#F4F6F7","logoFile":"","sitetitle":"","sitedescription":"","googleFont":"1","googleFontName":"Open+Sans","fluidContainer":"0"}');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_ucm_base`
--

CREATE TABLE IF NOT EXISTS `t1opn_ucm_base` (
...
--
-- Table structure for table `t1opn_ucm_content`
--

CREATE TABLE IF NOT EXISTS `t1opn_ucm_content` (
...
--
-- Table structure for table `t1opn_ucm_history`
--

CREATE TABLE IF NOT EXISTS `t1opn_ucm_history` (
...
--
-- Dumping data for table `t1opn_ucm_history`
--

INSERT INTO `t1opn_ucm_history` (`version_id`, `ucm_item_id`, `ucm_type_id`, `version_note`, `save_date`, `editor_user_id`, `character_count`, `sha1_hash`, `version_data`, `keep_forever`) VALUES
(1, 1, 1, '', '2015-02-08 20:46:04', 990, 1672, 'b03679af32603c1c9f257588d91ba75409fd43e0', '{"id":1,"asset_id":54,"title":"test template","alias":"test-template","introtext":"<p>Hostgator coupons<\\/p>","fulltext":"","state":1,"catid":"2","created":"2015-02-08 20:46:04","created_by":"990","created_by_alias":"","modified":"","modified_by":null,"checked_out":null,"checked_out_time":null,"publish_up":"2015-02-08 20:46:04","publish_down":"0000-00-00 00:00:00","images":"{\\"image_intro\\":\\"\\",\\"float_intro\\":\\"\\",\\"image_intro_alt\\":\\"\\",\\"image_intro_caption\\":\\"\\",\\"image_fulltext\\":\\"\\",\\"float_fulltext\\":\\"\\",\\"image_fulltext_alt\\":\\"\\",\\"image_fulltext_caption\\":\\"\\"}","urls":"{\\"urla\\":false,\\"urlatext\\":\\"\\",\\"targeta\\":\\"\\",\\"urlb\\":false,\\"urlbtext\\":\\"\\",\\"targetb\\":\\"\\",\\"urlc\\":false,\\"urlctext\\":\\"\\",\\"targetc\\":\\"\\"}","attribs":"{\\"show_title\\":\\"\\",\\"link_titles\\":\\"\\",\\"show_tags\\":\\"\\",\\"show_intro\\":\\"\\",\\"info_block_position\\":\\"\\",\\"show_category\\":\\"\\",\\"link_category\\":\\"\\",\\"show_parent_category\\":\\"\\",\\"link_parent_category\\":\\"\\",\\"show_author\\":\\"\\",\\"link_author\\":\\"\\",\\"show_create_date\\":\\"\\",\\"show_modify_date\\":\\"\\",\\"show_publish_date\\":\\"\\",\\"show_item_navigation\\":\\"\\",\\"show_icons\\":\\"\\",\\"show_print_icon\\":\\"\\",\\"show_email_icon\\":\\"\\",\\"show_vote\\":\\"\\",\\"show_hits\\":\\"\\",\\"show_noauth\\":\\"\\",\\"urls_position\\":\\"\\",\\"alternative_readmore\\":\\"\\",\\"article_layout\\":\\"\\",\\"show_publishing_options\\":\\"\\",\\"show_article_options\\":\\"\\",\\"show_urls_images_backend\\":\\"\\",\\"show_urls_images_frontend\\":\\"\\"}","version":1,"ordering":null,"metakey":"","metadesc":"","access":"1","hits":null,"metadata":"{\\"robots\\":\\"\\",\\"author\\":\\"\\",\\"rights\\":\\"\\",\\"xreference\\":\\"\\"}","featured":"0","language":"*","xreference":""}', 0);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_updates`
--

CREATE TABLE IF NOT EXISTS `t1opn_updates` (
...
--
-- Dumping data for table `t1opn_updates`
--

INSERT INTO `t1opn_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
--
-- Table structure for table `t1opn_update_sites`
--

CREATE TABLE IF NOT EXISTS `t1opn_update_sites` (
...
--
-- Dumping data for table `t1opn_update_sites`
--

INSERT INTO `t1opn_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1423431000, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1423431000, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1423430997, ''),
(4, 'Joomla! Update Component Update Site', 'extension', 'http://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1423430997, '');

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_update_sites_extensions`
--

CREATE TABLE IF NOT EXISTS `t1opn_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Links extensions to update sites';

--
-- Dumping data for table `t1opn_update_sites_extensions`
--

INSERT INTO `t1opn_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 700),
(3, 600),
(4, 28);
...
--
-- Table structure for table `t1opn_usergroups`
--

CREATE TABLE IF NOT EXISTS `t1opn_usergroups` (
`id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
...
--
-- Dumping data for table `t1opn_usergroups`
--

INSERT INTO `t1opn_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Table structure for table `t1opn_users`
--

CREATE TABLE IF NOT EXISTS `t1opn_users` (
`id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL DEFAULT '',
...
--
-- Dumping data for table `t1opn_users`
--

INSERT INTO `t1opn_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(990, 'Super User', 'hostgator', 'ken1901vn@gmail.com', '$2y$10$gHP00e1roWGUEzaXfT9rouXQZyoRYmNzOuU3le3dF20UBCSgfe0om', 0, 1, '2015-02-08 07:45:39', '2015-02-08 21:29:54', '0', '', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_user_keys`
--

CREATE TABLE IF NOT EXISTS `t1opn_user_keys` (
`id` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `t1opn_user_notes`
--

CREATE TABLE IF NOT EXISTS `t1opn_user_notes` (
`id` int(10) unsigned NOT NULL,
  `user_id` int(10) unsigned NOT NULL DEFAULT '0',
  `catid` int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Table structure for table `t1opn_user_profiles`
--

CREATE TABLE IF NOT EXISTS `t1opn_user_profiles` (
...
--
-- Table structure for table `t1opn_user_usergroup_map`
--

CREATE TABLE IF NOT EXISTS `t1opn_user_usergroup_map` (
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `t1opn_user_usergroup_map`
--

INSERT INTO `t1opn_user_usergroup_map` (`user_id`, `group_id`) VALUES
(990, 8);

-- --------------------------------------------------------

--
-- Table structure for table `t1opn_viewlevels`
--

CREATE TABLE IF NOT EXISTS `t1opn_viewlevels` (
`id` int(10) unsigned NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Dumping data for table `t1opn_viewlevels`
--

INSERT INTO `t1opn_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Table structure for table `t1opn_weblinks`
--

CREATE TABLE IF NOT EXISTS `t1opn_weblinks` (
`id` int(10) unsigned NOT NULL,
  `catid` int(11) NOT NULL DEFAULT '0',
...
--
-- Indexes for table `t1opn_assets`
--
ALTER TABLE `t1opn_assets`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_asset_name` (`name`), ADD KEY `idx_lft_rgt` (`lft`,`rgt`), ADD KEY `idx_parent_id` (`parent_id`);

--
-- Indexes for table `t1opn_associations`
--
ALTER TABLE `t1opn_associations`
 ADD PRIMARY KEY (`context`,`id`), ADD KEY `idx_key` (`key`);

--
-- Indexes for table `t1opn_banners`
--
ALTER TABLE `t1opn_banners`
...
--
-- Indexes for table `t1opn_banner_clients`
--
ALTER TABLE `t1opn_banner_clients`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_own_prefix` (`own_prefix`), ADD KEY `idx_metakey_prefix` (`metakey_prefix`);

--
-- Indexes for table `t1opn_banner_tracks`
--
ALTER TABLE `t1opn_banner_tracks`
...
--
-- Indexes for table `t1opn_categories`
--
ALTER TABLE `t1opn_categories`
...
--
-- Indexes for table `t1opn_contact_details`
--
ALTER TABLE `t1opn_contact_details`
...
--
-- Indexes for table `t1opn_content`
--
ALTER TABLE `t1opn_content`
...
--
-- Indexes for table `t1opn_contentitem_tag_map`
--
ALTER TABLE `t1opn_contentitem_tag_map`
...
--
-- Indexes for table `t1opn_content_frontpage`
--
ALTER TABLE `t1opn_content_frontpage`
 ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `t1opn_content_rating`
--
ALTER TABLE `t1opn_content_rating`
 ADD PRIMARY KEY (`content_id`);

--
-- Indexes for table `t1opn_content_types`
--
ALTER TABLE `t1opn_content_types`
 ADD PRIMARY KEY (`type_id`), ADD KEY `idx_alias` (`type_alias`);

--
-- Indexes for table `t1opn_extensions`
--
ALTER TABLE `t1opn_extensions`
...
--
-- Indexes for table `t1opn_finder_filters`
--
ALTER TABLE `t1opn_finder_filters`
 ADD PRIMARY KEY (`filter_id`);

--
-- Indexes for table `t1opn_finder_links`
--
ALTER TABLE `t1opn_finder_links`
...
--
-- Indexes for table `t1opn_finder_links_terms0`
--
ALTER TABLE `t1opn_finder_links_terms0`
...
--
-- Indexes for table `t1opn_finder_links_terms1`
--
ALTER TABLE `t1opn_finder_links_terms1`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms2`
--
ALTER TABLE `t1opn_finder_links_terms2`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms3`
--
ALTER TABLE `t1opn_finder_links_terms3`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms4`
--
ALTER TABLE `t1opn_finder_links_terms4`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms5`
--
ALTER TABLE `t1opn_finder_links_terms5`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms6`
--
ALTER TABLE `t1opn_finder_links_terms6`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms7`
--
ALTER TABLE `t1opn_finder_links_terms7`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms8`
--
ALTER TABLE `t1opn_finder_links_terms8`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_terms9`
--
ALTER TABLE `t1opn_finder_links_terms9`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termsa`
--
ALTER TABLE `t1opn_finder_links_termsa`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termsb`
--
ALTER TABLE `t1opn_finder_links_termsb`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termsc`
--
ALTER TABLE `t1opn_finder_links_termsc`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termsd`
--
ALTER TABLE `t1opn_finder_links_termsd`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termse`
--
ALTER TABLE `t1opn_finder_links_termse`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_links_termsf`
--
ALTER TABLE `t1opn_finder_links_termsf`
 ADD PRIMARY KEY (`link_id`,`term_id`), ADD KEY `idx_term_weight` (`term_id`,`weight`), ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Indexes for table `t1opn_finder_taxonomy`
--
ALTER TABLE `t1opn_finder_taxonomy`
...
--
-- Indexes for table `t1opn_finder_taxonomy_map`
--
ALTER TABLE `t1opn_finder_taxonomy_map`
 ADD PRIMARY KEY (`link_id`,`node_id`), ADD KEY `link_id` (`link_id`), ADD KEY `node_id` (`node_id`);

--
-- Indexes for table `t1opn_finder_terms`
--
ALTER TABLE `t1opn_finder_terms`
...
--
-- Indexes for table `t1opn_finder_terms_common`
--
ALTER TABLE `t1opn_finder_terms_common`
 ADD KEY `idx_word_lang` (`term`,`language`), ADD KEY `idx_lang` (`language`);

--
-- Indexes for table `t1opn_finder_tokens`
--
ALTER TABLE `t1opn_finder_tokens`
 ADD KEY `idx_word` (`term`), ADD KEY `idx_context` (`context`);

--
-- Indexes for table `t1opn_finder_tokens_aggregate`
--
ALTER TABLE `t1opn_finder_tokens_aggregate`
 ADD KEY `token` (`term`), ADD KEY `keyword_id` (`term_id`);

--
-- Indexes for table `t1opn_finder_types`
--
ALTER TABLE `t1opn_finder_types`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `title` (`title`);

--
-- Indexes for table `t1opn_languages`
--
ALTER TABLE `t1opn_languages`
...
--
-- Indexes for table `t1opn_menu`
--
ALTER TABLE `t1opn_menu`
...
--
-- Indexes for table `t1opn_menu_types`
--
ALTER TABLE `t1opn_menu_types`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Indexes for table `t1opn_messages`
--
ALTER TABLE `t1opn_messages`
 ADD PRIMARY KEY (`message_id`), ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Indexes for table `t1opn_messages_cfg`
--
ALTER TABLE `t1opn_messages_cfg`
 ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Indexes for table `t1opn_modules`
--
ALTER TABLE `t1opn_modules`
 ADD PRIMARY KEY (`id`), ADD KEY `published` (`published`,`access`), ADD KEY `newsfeeds` (`module`,`published`), ADD KEY `idx_language` (`language`);

--
-- Indexes for table `t1opn_modules_menu`
--
ALTER TABLE `t1opn_modules_menu`
 ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Indexes for table `t1opn_newsfeeds`
--
ALTER TABLE `t1opn_newsfeeds`
...
--
-- Indexes for table `t1opn_overrider`
--
ALTER TABLE `t1opn_overrider`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `t1opn_postinstall_messages`
--
ALTER TABLE `t1opn_postinstall_messages`
 ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Indexes for table `t1opn_redirect_links`
--
ALTER TABLE `t1opn_redirect_links`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_link_old` (`old_url`), ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Indexes for table `t1opn_schemas`
--
ALTER TABLE `t1opn_schemas`
 ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Indexes for table `t1opn_session`
--
ALTER TABLE `t1opn_session`
 ADD PRIMARY KEY (`session_id`), ADD KEY `userid` (`userid`), ADD KEY `time` (`time`);

--
-- Indexes for table `t1opn_tags`
--
ALTER TABLE `t1opn_tags`
...
--
-- Indexes for table `t1opn_template_styles`
--
ALTER TABLE `t1opn_template_styles`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_template` (`template`), ADD KEY `idx_home` (`home`);

--
-- Indexes for table `t1opn_ucm_base`
--
ALTER TABLE `t1opn_ucm_base`
...
--
-- Indexes for table `t1opn_ucm_content`
--
ALTER TABLE `t1opn_ucm_content`
...
--
-- Indexes for table `t1opn_ucm_history`
--
ALTER TABLE `t1opn_ucm_history`
 ADD PRIMARY KEY (`version_id`), ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`), ADD KEY `idx_save_date` (`save_date`);

--
-- Indexes for table `t1opn_updates`
--
ALTER TABLE `t1opn_updates`
 ADD PRIMARY KEY (`update_id`);

--
-- Indexes for table `t1opn_update_sites`
--
ALTER TABLE `t1opn_update_sites`
 ADD PRIMARY KEY (`update_site_id`);

--
-- Indexes for table `t1opn_update_sites_extensions`
--
ALTER TABLE `t1opn_update_sites_extensions`
 ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Indexes for table `t1opn_usergroups`
--
ALTER TABLE `t1opn_usergroups`
...
--
-- Indexes for table `t1opn_users`
--
ALTER TABLE `t1opn_users`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_name` (`name`), ADD KEY `idx_block` (`block`), ADD KEY `username` (`username`), ADD KEY `email` (`email`);

--
-- Indexes for table `t1opn_user_keys`
--
ALTER TABLE `t1opn_user_keys`
...
--
-- Indexes for table `t1opn_user_notes`
--
ALTER TABLE `t1opn_user_notes`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_user_id` (`user_id`), ADD KEY `idx_category_id` (`catid`);

--
-- Indexes for table `t1opn_user_profiles`
--
ALTER TABLE `t1opn_user_profiles`
 ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Indexes for table `t1opn_user_usergroup_map`
--
ALTER TABLE `t1opn_user_usergroup_map`
 ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Indexes for table `t1opn_viewlevels`
--
ALTER TABLE `t1opn_viewlevels`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `idx_assetgroup_title_lookup` (`title`);

--
-- Indexes for table `t1opn_weblinks`
--
ALTER TABLE `t1opn_weblinks`
 ADD PRIMARY KEY (`id`), ADD KEY `idx_access` (`access`), ADD KEY `idx_checkout` (`checked_out`), ADD KEY `idx_state` (`state`), ADD KEY `idx_catid` (`catid`), ADD KEY `idx_createdby` (`created_by`), ADD KEY `idx_featured_catid` (`featured`,`catid`), ADD KEY `idx_language` (`language`), ADD KEY `idx_xreference` (`xreference`);
...
--
-- AUTO_INCREMENT for table `t1opn_assets`
--
ALTER TABLE `t1opn_assets`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT for table `t1opn_banners`
--
ALTER TABLE `t1opn_banners`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_banner_clients`
--
ALTER TABLE `t1opn_banner_clients`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_categories`
--
ALTER TABLE `t1opn_categories`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `t1opn_contact_details`
--
ALTER TABLE `t1opn_contact_details`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_content`
--
ALTER TABLE `t1opn_content`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_content_types`
--
ALTER TABLE `t1opn_content_types`
MODIFY `type_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
-- AUTO_INCREMENT for table `t1opn_extensions`
--
ALTER TABLE `t1opn_extensions`
MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10001;
--
-- AUTO_INCREMENT for table `t1opn_finder_filters`
--
ALTER TABLE `t1opn_finder_filters`
MODIFY `filter_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_finder_links`
--
ALTER TABLE `t1opn_finder_links`
MODIFY `link_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_finder_taxonomy`
--
ALTER TABLE `t1opn_finder_taxonomy`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_finder_terms`
--
ALTER TABLE `t1opn_finder_terms`
MODIFY `term_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_finder_types`
--
ALTER TABLE `t1opn_finder_types`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_languages`
--
ALTER TABLE `t1opn_languages`
MODIFY `lang_id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_menu`
--
ALTER TABLE `t1opn_menu`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=107;
--
-- AUTO_INCREMENT for table `t1opn_menu_types`
--
ALTER TABLE `t1opn_menu_types`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_messages`
--
ALTER TABLE `t1opn_messages`
MODIFY `message_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_modules`
--
ALTER TABLE `t1opn_modules`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=87;
--
-- AUTO_INCREMENT for table `t1opn_newsfeeds`
--
ALTER TABLE `t1opn_newsfeeds`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_overrider`
--
ALTER TABLE `t1opn_overrider`
MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';
--
-- AUTO_INCREMENT for table `t1opn_postinstall_messages`
--
ALTER TABLE `t1opn_postinstall_messages`
MODIFY `postinstall_message_id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `t1opn_redirect_links`
--
ALTER TABLE `t1opn_redirect_links`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_tags`
--
ALTER TABLE `t1opn_tags`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_template_styles`
--
ALTER TABLE `t1opn_template_styles`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `t1opn_ucm_content`
--
ALTER TABLE `t1opn_ucm_content`
MODIFY `core_content_id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_ucm_history`
--
ALTER TABLE `t1opn_ucm_history`
MODIFY `version_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `t1opn_updates`
--
ALTER TABLE `t1opn_updates`
MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=58;
--
-- AUTO_INCREMENT for table `t1opn_update_sites`
--
ALTER TABLE `t1opn_update_sites`
MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `t1opn_usergroups`
--
ALTER TABLE `t1opn_usergroups`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `t1opn_users`
--
ALTER TABLE `t1opn_users`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=991;
--
-- AUTO_INCREMENT for table `t1opn_user_keys`
--
ALTER TABLE `t1opn_user_keys`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_user_notes`
--
ALTER TABLE `t1opn_user_notes`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `t1opn_viewlevels`
--
ALTER TABLE `t1opn_viewlevels`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT for table `t1opn_weblinks`
--
ALTER TABLE `t1opn_weblinks`
MODIFY `id` int(10) unsigned NOT NULL AUTO_INCREMENT;
